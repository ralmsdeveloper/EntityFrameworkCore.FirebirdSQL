...
{
    public class LoadFirebirdTest : LoadTestBase<LoadFirebirdTest.LoadFirebirdFixture>
    {
        public LoadFirebirdTest(LoadFirebirdFixture fixture)
            : base(fixture)
        {
        }

        public class LoadFirebirdFixture : LoadFixtureBase
        {
