...
namespace SouchProd.EntityFrameworkCore.Firebird.Tests.Migrations
{
    public class ServerVersionTest
    {
       /* [Theory]
        ...
        [InlineData("5.5.5-1.2.3-myslq~jessie", ServerType.Firebird, "5.5.5", false)]
        [InlineData("version5.0", ServerType.Firebird, "5.0", false)]
        [InlineData("5.1", ServerType.Firebird, "5.1", false)]
