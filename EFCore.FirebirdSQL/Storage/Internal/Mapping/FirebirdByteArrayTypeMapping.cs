...
namespace Microsoft.EntityFrameworkCore.Storage.Internal
{
    ...
    /// </summary>
    public class FirebirdSqlByteArrayTypeMapping : ByteArrayTypeMapping
    {
        private readonly int _maxSpecificSize;

        /// <summary>
        ///     Initializes a new instance of the <see cref="FirebirdSqlByteArrayTypeMapping" /> class.
        /// </summary>
        /// <param name="storeType"> The name of the database type. </param>
        /// <param name="dbType"> The <see cref="System.Data.DbType" /> to be used. </param>
        /// <param name="size"> The size of data the property is configured to store, or null if no size is configured. </param>
        public FirebirdSqlByteArrayTypeMapping(
...
=> new FirebirdSqlByteArrayTypeMapping(
    storeType,
    DbType);
