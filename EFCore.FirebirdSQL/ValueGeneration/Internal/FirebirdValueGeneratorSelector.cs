...
{
    public class FirebirdSqlValueGeneratorSelector : RelationalValueGeneratorSelector
    {
        ...
        public override ValueGenerator Create(IProperty property, IEntityType entityType)
        {
            ...
            var ret = property.ClrType.UnwrapNullableType() == typeof(Guid)
                ? property.ValueGenerated == ValueGenerated.Never
                  || property.FirebirdSql().DefaultValueSql != null
                    ? (ValueGenerator)new TemporaryGuidValueGenerator()
                    : new FirebirdSqlSequentialGuidValueGenerator(_options)
