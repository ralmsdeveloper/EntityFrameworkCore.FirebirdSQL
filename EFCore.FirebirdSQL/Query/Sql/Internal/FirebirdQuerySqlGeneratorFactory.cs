...
{
    public class FirebirdSqlQuerySqlGeneratorFactory : QuerySqlGeneratorFactoryBase
    {
        public FirebirdSqlQuerySqlGeneratorFactory([NotNull] QuerySqlGeneratorDependencies dependencies)
            : base(dependencies)
        {
        }

        public override IQuerySqlGenerator CreateDefault(SelectExpression selectExpression)
            => new FirebirdSqlQuerySqlGenerator(
                Dependencies,
