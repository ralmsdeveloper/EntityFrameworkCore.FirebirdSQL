...
{ 
    public static class FirebirdSqlIndexBuilderExtensions
    {
        public static IndexBuilder ForFirebirdSqlIsFullText([NotNull] this IndexBuilder indexBuilder, bool fullText = true)
        {
            Check.NotNull(indexBuilder, nameof(indexBuilder)); 
            indexBuilder.Metadata.FirebirdSql().IsFullText = fullText;
