...
{
    public class FirebirdSqlIndexAnnotations : RelationalIndexAnnotations, IFirebirdSqlIndexAnnotations
    {
        public FirebirdSqlIndexAnnotations([NotNull] IIndex index)
            : base(index)
        {
        }
        ...
        protected virtual bool SetIsFullText(bool? value) 
            => Annotations.SetAnnotation(FirebirdSqlAnnotationNames.FullTextIndex,value);
