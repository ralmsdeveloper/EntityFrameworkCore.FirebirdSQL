...
{
    public class FirebirdSqlKeyAnnotations : RelationalKeyAnnotations, IFirebirdSqlKeyAnnotations
    {
        public FirebirdSqlKeyAnnotations([NotNull] IKey key)
            : base(key)
        {
        }

        protected FirebirdSqlKeyAnnotations([NotNull] RelationalAnnotations annotations)
            : base(annotations)
        {
        }
    }
